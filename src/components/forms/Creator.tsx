...
export default function Creator() {
  ...
  const mentors = [
    {
      ...
      department: "Conceptualization, Data Curation, Data Validation",
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Design and Web app Development Section */}
      <Card className="overflow-hidden bg-white/95">
        <CardHeader className="bg-gradient-to-r from-purple-500/20 to-purple-600/10">
          <CardTitle className="text-center">Design and Web app Development</CardTitle>
        </CardHeader>
